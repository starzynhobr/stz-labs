...
export const MOUSE_LOCALES = ['pt', 'en'];
export const DEFAULT_MOUSE_LOCALE = 'pt';
...
export const MOUSE_TOOLS = [
    {
        id: 'click',
        component: 'ClickTest',
        slugs: { pt: 'teste-de-clique', en: 'click-test' },
    ...
    },
    {
        ...
        slugs: { pt: 'double-click', en: 'double-click-test' },
        related: ['click', 'cps'],
    },
    {
        id: 'cps',
    ...
    },
    {
        ...
        slugs: { pt: 'scroll', en: 'scroll-test' },
        related: ['click', 'polling-rate'],
    },
    {
        id: 'polling-rate',
        component: 'PollingRateTest',
        slugs: { pt: 'taxa-de-atualizacao', en: 'polling-rate' },
        related: ['scroll', 'cps'],
