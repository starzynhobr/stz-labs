...
export default function Philosophy() {
    return (
        <section id="benefits" className="relative mt-24 md:mt-32">
            {/* Background Accent */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-purple-500/5 blur-[120px] pointer-events-none rounded-full" />
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 auto-rows-fr">
                {/* Item 1: Efficiency */}
                <div className="group relative bg-[#080A0E]/40 backdrop-blur-2xl border border-white/5 rounded-[24px] p-8 transition-all hover:bg-[#080A0E]/60 hover:border-purple-500/20 shadow-2xl flex flex-col items-center text-center md:items-start md:text-left">
                    <div className="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 mb-6 group-hover:scale-110 transition-transform duration-500 shadow-[0_0_20px_rgba(168,85,247,0.1)]">
