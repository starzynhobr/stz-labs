        ...
        <section id="roadmap" className="mt-24 md:mt-32 mb-12">
            <div className="max-w-3xl mx-auto">
                <div className="text-center mb-16 px-6">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--accent)]/10 border border-[var(--accent)]/20 text-[var(--accent)] text-[10px] font-bold uppercase tracking-[0.2em] mb-4">
                    ...
                    <TranslatedText
                        as="p"
                        className="text-[var(--text-muted)] text-[11px] font-mono mt-6 uppercase tracking-widest opacity-60"
                ...
                <div className="relative space-y-0 px-6">
                    {/* Vertical Line */}
                    <div className="absolute left-[31px] md:left-1/2 top-4 bottom-4 w-px bg-[var(--border-subtle)] md:-translate-x-1/2 hidden md:block" />
                    ...
                    <div className="relative flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-12 pb-12 group">
                        ...
                        <div className="md:w-1/2 order-3">
                            <TranslatedText as="span" className="text-[var(--text-muted)] font-mono text-[11px] uppercase tracking-wider" i18nKey="sections.roadmap_status_1" />
                        </div>
                    </div>
                    ...
                    <div className="relative flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-12 pb-12 group">
                        <div className="md:w-1/2 md:text-right order-2 md:order-1">
                            <TranslatedText as="h4" className="text-[var(--text-primary)] text-sm font-bold mb-1" i18nKey="sections.roadmap_q2" />
                            <TranslatedText as="p" className="text-[var(--text-secondary)] text-[12px] leading-relaxed" i18nKey="sections.roadmap_q2_desc" />
                        </div>
                        <div className="relative z-10 flex items-center justify-center w-16 h-8 rounded-lg bg-[var(--accent)]/10 border border-[var(--accent)]/20 order-1 md:order-2 shrink-0 shadow-[0_0_15px_var(--accent-glow)]">
                            <TranslatedText as="span" className="text-[var(--accent)] font-mono text-[10px] font-bold tracking-tighter animate-pulse" i18nKey="common.status.beta" />
                        </div>
                        <div className="md:w-1/2 order-3">
                            <TranslatedText as="span" className="text-[var(--text-muted)] font-mono text-[11px] uppercase tracking-wider" i18nKey="sections.roadmap_status_2" />
                        </div>
                    </div>
                    ...
                    <div className="relative flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-12 group opacity-40 grayscale">
                        <div className="md:w-1/2 md:text-right order-2 md:order-1">
                            <TranslatedText as="h4" className="text-[var(--text-primary)] text-sm font-bold mb-1" i18nKey="sections.roadmap_q4" />
                            <TranslatedText as="p" className="text-[var(--text-secondary)] text-[12px] leading-relaxed" i18nKey="sections.roadmap_q4_desc" />
                        </div>
                        <div className="relative z-10 flex items-center justify-center w-16 h-8 rounded-lg bg-[var(--surface-2)] border border-[var(--border-subtle)] order-1 md:order-2 shrink-0">
                            <TranslatedText as="span" className="text-[var(--text-muted)] font-mono text-[10px] font-bold tracking-tighter" i18nKey="common.status.experimental" />
                        </div>
                        <div className="md:w-1/2 order-3">
                            <TranslatedText as="span" className="text-[var(--text-muted)] font-mono text-[11px] uppercase tracking-wider" i18nKey="sections.roadmap_status_4" />
                        </div>
                    </div>
                </div>
            </div>
