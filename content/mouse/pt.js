    ...
    'polling-rate': {
        ...
        sections: [
            ...
            },
            {
                ...
                body: 'A taxa se ajusta no software do fabricante — Razer Synapse, Logitech G HUB, Corsair iCUE, SteelSeries GG — normalmente em uma seção de desempenho. Alguns mouses têm um botão físico ou combinação de teclas para alternar sem software.\n\nSe o valor medido aqui ficar bem abaixo do configurado, considere as limitações do navegador antes de suspeitar do mouse. Navegadores agrupam eventos de movimento por quadro renderizado, então um monitor a 60 Hz tende a limitar a leitura. Mova o mouse continuamente e em movimentos amplos para reduzir o efeito. Uma leitura consistentemente próxima da metade do configurado costuma indicar problema real: cabo, receptor sem fio distante ou interferência de USB 3.0, que é uma fonte clássica de ruído em receptores de 2,4 GHz.',
            },
        ],
        faq: [
            {
                q: 'Por que a medição não bate com os 1000 Hz configurados?',
                a: 'O navegador entrega eventos de movimento agrupados por quadro, então a leitura é um piso, não um teto. Valores próximos da taxa de atualização do monitor são normais. O teste serve melhor para comparar configurações do que para certificar o número exato.',
            },
            {
